...
router.get("/", async (req, res) => {
  try {
    ...
    const categories = ["altars", "deities", "sculptures", "custom", "furniture", "tulsi_table_vyasasna","mridanga_stand","Prabhupada_altars","temple_altar"];
    const allProducts = [];
...
router.get("/:category", async (req, res) => {
  try {
    ...
    // Validate category
    const validCategories = ["altars", "deities", "sculptures", "custom", "furniture", "tulsi_table_vyasasna","mridanga_stand","Prabhupada_altars","temple_altar"];
